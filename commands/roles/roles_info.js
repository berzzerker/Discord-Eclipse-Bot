...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("roles-info")
        .setDescription(
            "Muestra una guía completa de todos los roles disponibles en Eclipse Studios.",
        ),
    async execute(interaction) {
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                {
                    name: "\u200B",
                    value: "Si quieres postularte a algún rol, abre un ticket y dinos cuál te interesa. ¡Estamos buscando talento! 🌑✨",
                },
            );
